...
class SdAvailableActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        dref!!.addValueEventListener(object : ValueEventListener {
            override fun onDataChange(dataSnapshot: DataSnapshot) {
                av = dataSnapshot.child("Parking Area").child("Sd").child("Available").getValue(Int::class.java)!!
                bk = dataSnapshot.child("Parking Area").child("Sd").child("Booked").getValue(Int::class.java)!!
            }
        ...
        databaseReference!!.addValueEventListener(object : ValueEventListener {
            override fun onDataChange(dataSnapshot: DataSnapshot) {
                val sama = dataSnapshot.child("Parking Area").child("Sd").child("Available").getValue(Int::class.java)!!
        ...
        bookAndPay.setOnClickListener {
            if (av == 0) {
                ...
                dref!!.child("Users").child(current_user!!.uid).child("loc").setValue(2)
